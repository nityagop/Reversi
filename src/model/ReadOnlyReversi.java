...
public interface ReadOnlyReversi {
  ...
  int getPotentialTiles(int x, int y);

  List<NoDiscSquare> getBoard();


  AbstractHexagon getHexagon2(int i, int i1, List<NoDiscSquare> board);

  void startGame();

  List<AbstractHexagon> getBoardGame();
}
